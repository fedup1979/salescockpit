...
- Latest staging deployment: commit `b183939`, API/UI OK, `scripts/pre_cutover_check.py --api-base http://127.0.0.1:8602 --ui-url http://127.0.0.1:8502 --allow-cold-prod` OK after resetting the `SD-DEMO-*` demo scenarios.
...
- Latest verified staging commit: `b183939`.
